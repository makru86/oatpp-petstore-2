...
public:
  ...
  oatpp::Object<OrderDTO> placeOrder(const oatpp::Object<OrderDTO>& order) override { return {}; }

  oatpp::Object<OrderDTO> getOrderById(const oatpp::Int64& orderId) override { return {}; }
